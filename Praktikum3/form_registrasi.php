...
<body>
    <div class="container">
        <h2>Form Input IT Clup GDSC</h2>

            <form method="POST">
            <div class="form-group row">
                <label for="nim" class="col-4 col-form-label">NIM</label> 
                <div class="col-8">
                <input id="nim" name="nim" placeholder="Maukkan NIM" type="text" class="form-control" required="required">
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <label class="col-4">Skills Programming</label> 
                <div class="col-8">
